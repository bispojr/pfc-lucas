...
Para {\color{red}Ballester et al. (2003)}, uma avaliação somativa possui uma função social, que é a de assegurar que as características dos estudantes respondam a determinadas exigências feitas pelo sistema.
...
\label{tab:my-table}
\resizebox{\textwidth}{!}{%
\begin{tabular}{c|cccl|ccc|cclcccc}
 & \multicolumn{4}{c|}{\ref{sec:coleta}} & \multicolumn{3}{c|}{\ref{sec:metodo}} & \multicolumn{3}{c|}{\ref{sec:disc}} & \multicolumn{4}{c}{\ref{sec:geo}} \cline{4-18}
\multicolumn{1}{c|}{Artigos/Características} & \multicolumn{1}{c}{\ref{sec:snap}} & \ref{sec:moodle} & \ref{sec:notas} & \ref{sec:Meu} & \ref{sec:ML} & \ref{sec:RNA} & \ref{sec:WEKA} & \ref{sec:icc} & \ref{sec:1p} & \ref{sec:IHC} & \ref{sec:BR} & \ref{sec:EUA} & \ref{sec:EUR} & \ref{sec:Aus} \\ \hline
\citeonline{ahadi2016early} & X &  &  &  & X &  &  & X &  & \multicolumn{1}{l|}{} &  &  & X & X \\
\citeonline{Castro-Wunsch2017}& X &  &  &  &  & X &  & X &  & \multicolumn{1}{l|}{} &  & X & X &  \\
\citeonline{gotardo2013prediccao} &  & X &  &  & X &  &  & X &  & \multicolumn{1}{l|}{} & X &  &  &  \\
\citeonline{DeBrito2014} &  &  & X &  &  &  & X &  & X & \multicolumn{1}{l|}{} & X &  &  &  \\
\hline \hline
...
\caption{}
\label{tab:my-table}
\begin{tabular}{cccclccccclcccc}
 & \multicolumn{4}{c}{\ref{sec:coleta}} & \multicolumn{3}{c}{\ref{sec:metodo}} & \multicolumn{2}{c}{\ref{sec:disc}} &  & \multicolumn{4}{c}{\ref{sec:geo}} \\ \cline{2-2}
\multicolumn{1}{c|}{Artigos/Características} & \multicolumn{1}{c|}{\ref{sec:snap}} & \ref{sec:moodle} & \ref{sec:notas} & \ref{sec:Meu} & \ref{sec:ML} & \ref{sec:RNA} & \ref{sec:WEKA} & \ref{sec:icc} & \ref{sec:1p} & \ref{sec:IHC} & \ref{sec:BR} & \ref{sec:EUA} & \ref{sec:EUR} & \ref{sec:Aus} \\ \cline{2-2}
1 & X &  &  &  & X &  &  & X &  &  &  &  & X & X \\
2 & X &  &  &  &  & X &  & X &  &  &  & X & X &  \\
3 &  & X &  &  & X &  &  & X &  &  & X &  &  &  \\
4 &  &  & X &  &  &  & X &  & X &  & X &  &  &  \\
...
\begin{table}[htb]
	\centering
	\caption{Características da relação dos trabalhos}
	\vspace{0.5cm}
	\begin{tabular}{
		...
		\hline
		Artigos / Características	& ARL	& CPMP / Phi	& Aprend. de Máquina		& Árvore de Decisão &
		WEKA	& Outros \\
		\hline
		\citeonline{ahadi2016early} &  &  & $\times$ & & & \\
		\hline
		\citeonline{Castro-Wunsch2017} & & $\times$ & & & & \\
		\hline
		\citeonline{gotardo2013prediccao} &  &  & $\times$ & & & \\
		\hline
		\citeonline{DeBrito2014} & & & & & $\times$ & \\
		\hline
		TOTAL & 4 & 5 & 3 & 2 & 3 & 2 \\
		\hline
\label{tab:trabalhos}
