...
\begin{itemize} 
    ...
    \item Notas - fornecidos pela STI da Universidade - de ingresso e do primeiro período do curso: Notas obtidas pelos alunos ao ingressarem na Universidade e as notas obtidas nas disciplinas do primeiro período. As notas foram fornecidas pela STI - Superintendência de Tecnologia da Informação da UFPB - Universidade Federal da Paraíba.
...
\label{sec:HS}
A seguinte proposição foi estabelecida a fim de ser investigada. \textbf{P1: ``Sim, é possível alcançar um nível satisfatório de precisão e acurácia da previsão de desempenho acadêmico dos alunos.''}
