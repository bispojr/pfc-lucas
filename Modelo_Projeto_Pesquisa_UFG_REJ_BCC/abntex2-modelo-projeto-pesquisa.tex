...
\multicolumn{1}{c|}{Artigos/Características} & \multicolumn{1}{c|}{\ref{sec:snap}} & \ref{sec:moodle} & \ref{sec:notas} & \ref{sec:Meu} & \ref{sec:ML} & \ref{sec:RNA2} & \ref{sec:WEKA} & \ref{sec:icc} & \ref{sec:1p} & \ref{sec:IHC} & \ref{sec:BR} & \ref{sec:EUA} & \ref{sec:EUR} & \ref{sec:Aus} \\ \cline{2-2}
1 & X &  &  &  & X &  &  & X &  &  &  &  & X & X \\
2 & X &  &  &  &  & X &  & X &  &  &  & X & X &  \\
3 &  & X &  &  & X &  &  & X &  &  & X &  &  &  \\
4 &  &  & X &  &  &  & X &  & X &  & X &  &  &  \\
